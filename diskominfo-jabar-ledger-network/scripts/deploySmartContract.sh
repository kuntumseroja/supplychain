...
CC_SRC_PATH="organizations/rawmaterial/contract/"
...
echo
echo "Deploy smart contract Diskominfo Jabar Ledger Network (DLN) fabric blockchain"
echo
...
echo
echo "========= Diskominfo Jabar Ledger Network (DLN) contract successfully deployed on channel $CHANNEL_NAME  =========== "
